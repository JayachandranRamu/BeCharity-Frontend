...
export const VolunteerDonation= () => {
    ...
    const datas=useSelector((store)=>(store.AuthReducer))
...
<Box color={"black"}      style={{
          ...
          backgroundRepeat: "no-repeat",
             ...
             <Navbar />
             <Flex justifyContent={"center"}  alignItems={"center"} m={"auto"} h={"150px"} >
          <Box>
            <Text fontWeight={'500'} fontSize={["30", "45"]}  lineHeight={"60px"} textAlign={"center"} fontFamily={'DM Serif Display'}>Fundraising on BeCharity</Text>
          </Box>
